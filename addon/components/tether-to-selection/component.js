    ...
    schedule('afterRender', () => {
      ...
      if (isOffscreen) {
        ...
        this.element.style.left =
          isOffscreen.left ? DIALOG_MARGIN : (isOffscreen.right ? 'auto' : dialogAnchor.left);
        this.element.style.right = isOffscreen.right ? DIALOG_MARGIN : 'auto';
        this.element.style.top = isOffscreen.top ? DIALOG_MARGIN : 'auto';
        this.element.style.bottom =
          isOffscreen.bottom ? DIALOG_MARGIN : (isOffscreen.top ? 'auto' : dialogAnchor.bottom);
      }
    });
  }
});
